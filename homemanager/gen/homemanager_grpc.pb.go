...
const (
	RoomService_Create_FullMethodName = "/homemanager.RoomService/Create"
	RoomService_Get_FullMethodName    = "/homemanager.RoomService/Get"
	RoomService_GetAll_FullMethodName = "/homemanager.RoomService/GetAll"
)
...
type RoomServiceClient interface {
	...
	Get(ctx context.Context, in *GetRoomRequest, opts ...grpc.CallOption) (*GetRoomResponse, error)
	GetAll(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*GetAllRoomsResponse, error)
}
...
func (c *roomServiceClient) Get(ctx context.Context, in *GetRoomRequest, opts ...grpc.CallOption) (*GetRoomResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetRoomResponse)
	err := c.cc.Invoke(ctx, RoomService_Get_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *roomServiceClient) GetAll(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*GetAllRoomsResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetAllRoomsResponse)
	err := c.cc.Invoke(ctx, RoomService_GetAll_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type RoomServiceServer interface {
	...
	Get(context.Context, *GetRoomRequest) (*GetRoomResponse, error)
	GetAll(context.Context, *Empty) (*GetAllRoomsResponse, error)
...
func (UnimplementedRoomServiceServer) Get(context.Context, *GetRoomRequest) (*GetRoomResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Get not implemented")
}
func (UnimplementedRoomServiceServer) GetAll(context.Context, *Empty) (*GetAllRoomsResponse, error) {
...
func _RoomService_Get_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: RoomService_Get_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RoomServiceServer).Get(ctx, req.(*GetRoomRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _RoomService_GetAll_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Empty)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(RoomServiceServer).GetAll(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: RoomService_GetAll_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RoomServiceServer).GetAll(ctx, req.(*Empty))
	}
	return interceptor(ctx, in, info, handler)
}
...
var RoomService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "homemanager.RoomService",
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetAll",
			Handler:    _RoomService_GetAll_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "homemanager.proto",
}
...
var UsersService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "homemanager.UsersService",
